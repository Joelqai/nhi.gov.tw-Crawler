...
PEPTIC_DICT = {
    "816": "消化性潰瘍病患接受除菌藥物治療比率",
    "818": "消化性潰瘍病患開始治療1年內有用口服抗發炎劑比率"
}
...
def getTableData(year, option):
    ...
    try:
        driver.get("http://www1.nhi.gov.tw/mqinfo/SearchPro.aspx?Type=Peptic&List=4")
...
for option in PEPTIC_OPTION:
    for year in YEAR_LIST:
        print("{} {}".format(YEAR_DICT[year], PEPTIC_DICT[option]))
