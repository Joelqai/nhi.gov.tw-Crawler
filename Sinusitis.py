...
NAME = "鼻竇炎"
YEAR_LIST = [
    "101Q1", "101Q2", "101Q3", "101Q4", "102Q1", "102Q2", "102Q3", "102Q4", "103Q1", "103Q2", "103Q3", "103Q4", "104Q1", "104Q2", "104Q3", "104Q4", "105Q1", "105Q2", "105Q3", "105Q4", "106Q1", "106Q2", "106Q3"
]
...
SINUSITIS_OPTION = [
    "1743", "2201", "2202", "2203", "2204"
]

SINUSITIS_DICT = {
    "1743": "十八歲以上慢性鼻竇炎病人於住院手術前三個月內有做電腦斷層造影或鼻竇內視鏡檢查比率",
    "2201": "成人於急性鼻竇炎使用氟化恩菎類抗生素(Fluoroquinolones)案件比率",
    "2202": "成人於慢性鼻竇炎使用氟化恩菎類抗生素(Fluoroquinolones)案件比率",
    "2203": "兒童於急性鼻竇炎使用氟化恩菎類抗生素(Fluoroquinolones)案件比率",
    "2204": "兒童於慢性鼻竇炎使用氟化恩菎類抗生素(Fluoroquinolones)案件比率"
}

def dict2CSV(data, year, option):
    keys = data[0].keys()
    with open('{}/{}_{}.csv'.format(NAME, YEAR_DICT[year], SINUSITIS_DICT[option]), 'w', encoding="utf8") as f:
...
def checkExist(year, option):
    ...
    if not os.path.isdir(NAME):
        os.makedirs(NAME)
    if os.path.isfile("{}/{}_{}.csv".format(NAME, YEAR_DICT[year], SINUSITIS_DICT[option])):
        return True
    return False
...
def getTableData(year, option):
    ...
    try:
        driver.get("http://www1.nhi.gov.tw/mqinfo/SearchPro.aspx?Type=Sinusitis&List=4")
...
for option in SINUSITIS_OPTION:
    for year in YEAR_LIST:
        print("{} {}".format(YEAR_DICT[year], SINUSITIS_DICT[option]))
